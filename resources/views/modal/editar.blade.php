      ...
      <div class="modal-body">
        <form id='editar_tarefa'>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="tarefa_editar_titulo" name="tarefa_editar_titulo" required>
          </div>
          <div class="mb-3">
            <label for="tarefa_editar_descricao" class="col-form-label">Descrição:</label>
            <textarea class="form-control" id="tarefa_editar_descricao" name="tarefa_editar_descricao" required></textarea>
          </div>
          <div class="mb-3">
            <label for="tarefa_editar_data" class="col-form-label">Data:</label>
            <input type="text" class="form-control" id="tarefa_editar_data" name="tarefa_editar_data" required>
          </div>
          <div class="mb-3">
          <label for="tarefa_editar_data" class="col-form-label">Responsável:</label>
            <select class="form-select" id="editFloatingSelect" aria-label="Escolha o Responsável" id="multiple-select-field" name="tarefa_editar_responsavel" required>
